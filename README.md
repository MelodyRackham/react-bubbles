...
Tokens are used for granting access to users by a web server. JSON Web Tokens are a good way of securely transmitting information between parties.

- [ ] What steps can you take in your web apps to keep your data secure?

Use JSON Web Tokens. Authenticate users using axios with auth. Create private routes that only users who are singed in can access.

- [ ] Describe how web servers work.
      Web servers serve up data using a certain schema. They take in requests from clients and send the client information if the request meets their criteria.
